...
class VentadiariaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('ventadiaria.index', compact('existencias'))
    ...
    public function create()
    {
        ...
        return view('ventadiaria.create', compact('existencia','producto','estadoprod','factura'));
    }
    ...
    public function show($id)
    {
        ...
        return view('ventadiaria.show', compact('existencia'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('ventadiaria.edit', compact('existencia','producto','estadoprod','factura'));
    }
